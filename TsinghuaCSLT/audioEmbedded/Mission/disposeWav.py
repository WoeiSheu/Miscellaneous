...
def read_wave_data(file_path):      #读入wav文件
    ...
    time = np.arange(0, nframes/2) * (1.0/framerate)  #nframes or nframes/2, or maybe it's relative to samplewidth and nchannels.
...
def test():
    nchannels, sampwidth, framerate, nframes, wave_data, time = read_wave_data("test1.wav")
